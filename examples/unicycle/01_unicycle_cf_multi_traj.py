...
plt.savefig(f'figs/01_Trajectories_CF_Safe_Control_Multi_Trajs_{current_time}_300dpi.png', dpi=300)
plt.savefig(f'figs/01_Trajectories_CF_Safe_Control_Multi_Trajs_{current_time}_200dpi.png', dpi=200)
...
plt.savefig(f'figs/01_States_CF_Safe_Control_Multi_Trajs_{current_time}.png', dpi=300)
...
plt.savefig(f'figs/01_Barriers_CF_Safe_Control_Multi_Trajs_{current_time}.png', dpi=300)
